...
/**
 * m180902_132130_create_team_table.php
 *
 * PHP version 7
 *
 ...
 * @version    1.0.0
 */
class m180902_132130_create_team_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $this->createTable('team', [
            'id' => $this->primaryKey(7)->unsigned(),
            'name' => $this->string(64)->notNull(),
            'club_state' => $this->string(64)->notNull(),
